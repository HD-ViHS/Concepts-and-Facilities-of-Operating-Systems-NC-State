...
public class SmileySemaphore {
  ...
  /** Semaphores you declare and initialize here will be visible
    ...
    static Semaphore eyeSemaphore = new Semaphore(1);
    static Semaphore noseSemaphore = new Semaphore(0);
    static Semaphore mouthSemaphore = new Semaphore(0);
  ...
  static class EyePrinter extends PokyThread {
	...
	eyeSemaphore.acquireUninterruptibly();
  ...
  static class NosePrinter extends PokyThread {
	...
	noseSemaphore.acquireUninterruptibly();
        hesitate( 10 );

        // Print my symbol for the nose.
        System.out.print( sym );

	mouthSemaphore.release();
  ...
  static class MouthPrinter extends PokyThread {
	...
	mouthSemaphore.acquireUninterruptibly();
        hesitate( 10 );

        // I print the mouth symbol and the newline.
        System.out.println( sym );

	eyeSemaphore.release();
      }
    }
  }
