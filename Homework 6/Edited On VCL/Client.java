...
public class Client {
  public static void main( String[] args ) {
    ...
    try {
      ...
      byte[] rawChallengeCipher = RSAEncrypter.doFinal(challenge);
      Server.putMessage( output, rawChallengeCipher );
	...
	Server.putMessage( output, sessionKeyEncrypter.doFinal( request.getBytes() ) );
      ...
      Server.putMessage( output, sessionKeyEncrypter.doFinal( "quit".getBytes() ) );
